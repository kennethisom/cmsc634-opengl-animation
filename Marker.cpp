...
void Marker::initialize(float r_size) {
    ...
    vert[0] = vec3<float>( r_size,  0.f,  0.f);
    vert[1] = vec3<float>(-r_size,  0.f,  0.f);
    vert[2] = vec3<float>(  0.f, r_size,  0.f);
    vert[3] = vec3<float>(  0.f,-r_size,  0.f);
    vert[4] = vec3<float>(  0.f,  0.f, r_size);
    vert[5] = vec3<float>(  0.f,  0.f,-r_size);
